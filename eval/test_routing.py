...
The bot outputs JSON — we check if the expected urgency word appears in the response.
    ...
    return Task(
        dataset=[
            Sample(
                ...
                target="EMERGENCY",
                metadata={"expected_dept": "Cardiology"},
            ),
            Sample(
                input="I think I'm having a stroke, my left side is numb and I can't speak",
                target="EMERGENCY",
                metadata={"expected_dept": "General Practice"},
            ),
            Sample(
    ...
    return Task(
        dataset=[
            Sample(
                ...
                target="ROUTINE",
                metadata={"expected_dept": "Dermatology"},
            ),
            Sample(
